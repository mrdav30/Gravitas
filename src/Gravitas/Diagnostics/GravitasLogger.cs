...
{
    private static readonly GravitasDiagnosticLogger _logger = new();
    ...
    private sealed class GravitasDiagnosticLogger : DiagnosticLogger
    {
        public GravitasDiagnosticLogger()
            : base("Gravitas") { }
    }
}
