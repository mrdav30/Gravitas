...
internal sealed class DynamicCcdCandidateIndex
{
    ...
    public static FixedBoundVolume CreateSweptCircleBounds(Vector2d start, Vector2d displacement, Fixed64 radius)
    {
        ...
        return new FixedBoundVolume(new Vector3d(minX, Fixed64.Zero, minZ), new Vector3d(maxX, Fixed64.Zero, maxZ));
    }
