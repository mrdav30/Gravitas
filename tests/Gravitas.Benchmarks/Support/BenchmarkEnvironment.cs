...
{
    private static readonly Action _clearGravitasPools = CreateGravitasPoolClearer();
        ...
        int spatialGridCellSize = GridWorld.DefaultSpatialGridCellSize)
    {
        ...
        return GravitasWorldContext.CreateOwned(spatialGridCellSize: spatialGridCellSize);
    }
    ...
    private static void SuppressLogging()
    {
        ...
        GravitasLogger.MinimumLevel = DiagnosticLevel.None;
        GravitasLogger.EnableDebugLogging = false;
        _loggingSuppressed = true;
    }

    private static Action CreateGravitasPoolClearer()
    {
